...
const faqs = [
  ...
  { q: "Por que muitos motoristas preferem a Proauto?", a: "A Proauto se destaca por oferecer preço competitivo, atendimento ágil, processo simples, boa relação custo-benefício e total transparência nas regras e coberturas. Para quem busca proteção confiável, completa e sem burocracia, a proteção veicular da Proauto acaba sendo uma opção mais prática e econômica do que o seguro tradicional. Atuamos nas regiões de Americana e Campinas/SP." },
